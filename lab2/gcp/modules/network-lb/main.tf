...
locals {
  ...
  health_check_resource = try(
    google_compute_region_health_check.http.0,
    google_compute_region_health_check.https.0,
    google_compute_region_health_check.tcp.0,
    google_compute_region_health_check.ssl.0,
    google_compute_region_health_check.http2.0,
    {}
  )
...
resource "google_compute_region_health_check" "ssl" {
  provider = google-beta
  count = (
...
resource "google_compute_region_health_check" "http2" {
  provider = google-beta
  count = (
